...
<div class="header">
	...
	<div class="nav">
		<div class="u-container">
			<div class="logo" ><a href="${app}/index"><img style="vertical-align: middle;"  src="${appLogo}"></a></div><span class="logo2">${appOperationNickname}</span>
...
<div class="m_con m_fp m_fp3">
	<div class="m_fp_box jy_bg1 clearfix">	
		<div class="fl"><img src="${app.theme}/public/images/error/500.png"></div>
        <div class="fl ml_10 mt_60">
            <p>很抱歉，内部服务器发生错误，请稍后尝试！</p>
