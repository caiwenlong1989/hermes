<div class="row">
		<#list contacters as contacter>
			<div class="col-sm-6 col-md-6" id = "${contacter.id}">
				<div class="panel panel-info ">
					<div class="panel-heading clearfix">
						<h6 class="pull-left"><@messages key="model.contacter.info"/></h6>
						<div class="pull-right" >
						<a href="#" onclick="modifyContacter('${contacter.id}')"><i class="fa fa-pencil-square-o" style="font-size:2em;"></i></a>
						<a href="#" onclick="reMoveContacter('${contacter.id}',this)"><i class="fa fa-times-circle" style="font-size:2em;"></i></a>
						</div>
					</div>
...
function reMoveContacter(contacterId,obj){
   $.ajax({
		url: '${app}/account/delContacterDetail/'+contacterId,
		success:function(data) {
			 if(data == '00'){
