...
<div class="panel-body">
  ...
  <form class="form-horizontal" role="form" id="editForm" method="post">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" id="articleTitle"  name="articleTitle" placeholder="文章标题" value="${article.articleTitle!}" style="height:35px;">
        </div>
		<div class="col-xs-2">
        ...
        <div class="col-sm-8">
          <div class="row">
                <div class="col-xs-2 hm-col">
                    <select id="categoryLevelOne" name="levelOne" class="form-control" style="margin-left:25px;">
                ...
                <div class="col-xs-2 hm-col" style="margin-left:25px;">
			        <select id="categoryLevelTwo" name="levelTwo" class="form-control" style="margin-left:25px;">
			        	<option value="">请选择</option>
                ...
                <div class="col-xs-2 hm-col" style="margin-left:25px;">
			        <select id="categoryLevelThree" name="levelThree" class="form-control" style="margin-left:25px;">
						<option value="">请选择</option>
             ...
             <div class="col-xs-2" style="margin-left:25px;">
				<span class="alert-danger" style="display:none;background:none" style="margin-left:25px;">必填项</span>
			 </div>                                        
            </div>                                  
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" id="order" name="order" value="${article.order!}" style="height:35px;">
        </div>
        <div class="col-xs-2">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" id="keywords" name="keywords" placeholder="文章关键字" value="${article.keywords!}" style="height:35px;">
        </div>
...
jQuery(function($) { 
    ...
    //元素失去焦点时，触发数据校验事件
	function checkAll(){
		$("#articleTitle,#keywords,#description,#editor").blur();
